...
const Collaborate = () => {
  return (
    <div className="bg-white pt-20 px-4 lg:px-20">
      {/* Header Section */}
      ...
      <div className="flex justify-center items-center min-h-screen">
        <div className="flex flex-col lg:flex-row items-stretch lg:space-x-10 space-y-8 lg:space-y-0 w-full max-w-7xl">
          ...
          <div className="relative flex-1 bg-gray-100 h-full">
            ...
            <div className="absolute bottom-4 -left-14 p-4 w-80">
              <img
                ...
                src="https://i.ibb.co.com/CshyCpV/overlap.png"
                alt=""
              />
            </div>
          </div>
          ...
          <div className="flex-1 bg-gradient-to-b from-violet-50 to-violet-200 p-6 rounded-lg shadow-lg flex flex-col justify-between">
            {/* Heading */}
            <h2 className="text-4xl font-semibold mb-1 mt-6 ml-8">
              All Businesses
            </h2>
            ...
            <ul className="space-y-4 text-gray-500 font-semibold text-xl px-10">
              <li className="flex items-center space-x-4">
                <span className="text-2xl border border-gray-300 rounded-full p-2 ">
                  <HiOutlineGlobeAlt />
                </span>
                <span>
                  Work together globally, with translations for chats,
              ...
              <li className="flex items-center space-x-4">
                ...
                <span>
                  Streamline approval process for purchases, promotions, and
                  more.
                </span>
              </li>
            </ul>
