...
import { TbDeviceDesktop, TbFocus2 } from "react-icons/tb";
    ...
    <div className="bg-gradient-to-r from-slate-100 to-slate-50 min-h-screen flex flex-col items-center justify-center p-6 mt-10">
      ...
      <div className="text-center mb-12">
        <h1 className="text-3xl md:text-4xl font-semibold mb-4">
          The productivity <span className="text-blue-500">Superapp</span> all
          businesses need
        </h1>
        <p className="font-semibold md:text-lg text-gray-500 max-w-3xl mx-auto">
          Lark digitizes operations from HQ to storefront, streamlines
          communication, and empowers your business with tools for project
          management, video conferencing, chat, and more!
        </p>
      </div>
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                subtitle:
                  "Centralise all your business data in one place and mine insights",
              ...
              <div
                key={idx}
                className="group ml-16 px-2 py-2 md:px-4 md:py-4 rounded-lg hover:bg-white hover:shadow-lg"
              >
                ...
                <p className="text-gray-500 mt-2 h-0 group-hover:h-auto opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                  {item.subtitle}
                </p>
              </div>
            ))}
