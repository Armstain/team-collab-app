    ...
    <section className="py-12 px-6 bg-gray-50">
      ...
      <div className="flex flex-col lg:flex-row gap-16 max-w-7xl mx-auto">
        ...
        <div className="bg-[#f6f6fb] rounded-lg shadow-md p-6 flex-1">
          ...
          <button className="px-6 py-3 rounded-full border-2 border-[#3370FF] text-[#3370FF] font-medium hover:bg-[#3370FF] hover:text-white transition-colors">
            Try for free &rarr;
          </button>
        </div>
        ...
        <div className="bg-[#f6f6fb] rounded-lg shadow-md p-6 flex-1">
          ...
          <div className="flex space-x-4">
            <button className="px-6 py-3 rounded-full border-2 border-[#3370FF] text-white bg-[#3370FF] font-medium hover:bg-[#3370FF] hover:text-white transition-colors">
              Contact sales &rarr;
            </button>
            <button className="px-6 py-3 rounded-full border-2 border-[#3370FF] text-[#3370FF] font-medium hover:bg-[#3370FF] hover:text-white transition-colors">
              Buy Now
